...
def ReadPROBE():
  ...
  f.close()
  return probe
def ExtractFromTo(fromThis, track, toThis):
  print ("Extracting from " + fromThis + " track"+ track + " to " + toThis + " ... ")
  os.system('ffmpeg -i ' + '../' + fromThis + ' -map 0:' + str(track) + ' ' + toThis )
  ...
  for line in probe:
    ...
    if fields[2] == 'aac':
     ...
     if fields[1] != '1' :
      ...
      ExtractFromTo ( filename, fields[1], extractTo )
